# Operator Quickstart — Repair of Electrical Equipment

Shortest path from clone to a verified local dry-run for **ISIC 3314** (`cloud-itonami-isic-3314`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3314.git
cd cloud-itonami-isic-3314
```
...
- Blueprint governor key: `electrical-equipment-repair-governor`
- Likely source path: `electrical_equipment_repair.governor.cljc`
