# Business Model: Repair of Electrical Equipment
...
## Classification
- Repository: `cloud-itonami-isic-3314` ([github.com/cloud-itonami/cloud-itonami-isic-3314](https://github.com/cloud-itonami/cloud-itonami-isic-3314))
- ISIC Rev.5: `3314` — Repair of Electrical Equipment
- Domain: `:manufacturing/electrical-equipment-repair`
- Social impact: :worker-safety :repair-access :circular-economy-repair-over-replace
- Actor: `:electrical-equipment-repair-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :manufacturing/electrical-equipment-repair — who wants
...
One managed tenant (:manufacturing/electrical-equipment-repair):
...
- Do not bypass the `:electrical-equipment-repair-governor` for production decisions.
