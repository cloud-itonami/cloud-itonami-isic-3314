...
This project handles electrical-equipment-repair-shop coordination data
...
- Repair Governor bypass (including any path that lets a proposal
  ...
  repair-equipment/diagnostic-tool-control, return-to-service-sign-off
  or re-energization-sign-off marker through)
...
- If a real notification transport is ever added, keep its credentials
  ...
  `electrical-equipment-repair.notify/Notifier` via a portable (cljs/nbb)
