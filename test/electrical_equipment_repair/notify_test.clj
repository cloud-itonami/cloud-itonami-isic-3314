(ns electrical-equipment-repair.notify-test
  ...
  Twilio transport to stub-and-test -- see `electrical-equipment-repair.
  notify` ns docstring."
...
(deftest dispatch-safety-concern-notice-fans-out-to-every-contact-both-channels
  (let [n (notify/mock-notifier)
        contacts [{:name "Koji" :email "koji@example.com" :phone "+819000000021"}
                  {:name "Aiko" :email "aiko@example.com" :phone "+819000000022"}]
