(ns electrical-equipment-repair.phase-test
  ...
  `electrical-equipment-repair.phase` ns docstring 'Actuation' section,
  and note this actor's `:schedule-repair-operation` auto-eligibility is
  a deliberate DIFFERENCE from `cloud-itonami-isic-3320`'s `:schedule-
  installation-operation` (which is never auto-eligible), matching the
  shape `cloud-itonami-isic-3319` uses."
