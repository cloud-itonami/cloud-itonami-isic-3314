(ns electrical-equipment-repair.operation
  "OperationActor -- one electrical-equipment-repair-shop coordination
  ...
  `electrical-equipment-repair.phase`/`electrical-equipment-repair.
  governor` ns docstrings. `:log-repair-record`, `:schedule-repair-
  operation` (when governor-clean) and `:order-supplies` (below the cost
  threshold) MAY auto-commit at phase 3 when the governor is clean -- see
  `electrical-equipment-repair.phase` ns docstring.

  Every committed record carries `:effect :propose` (see `electrical-
  ...
  `electrical-equipment-repair.notify`) to the equipment/work-order's
...
(defn build
  ...
  `electrical-equipment-repair.store/Store`).
  opts:
    :advisor      -- an `electrical-equipment-repair.advisor/Advisor` (default: mock-advisor)
    :notifier     -- an `electrical-equipment-repair.notify/Notifier` (default: mock-notifier)
