(ns electrical-equipment-repair.notify
  ...
  the electrical-equipment-repair-domain analog of `installation.notify`/
  `demolition.notify`/`other-equipment-repair.notify`.
  ...
  escalates to a human first (see `electrical-equipment-repair.phase`/
  `electrical-equipment-repair.governor` ns docstrings), so by the time
  `electrical-equipment-repair.operation`'s `:commit` node calls this, a
...
(defn dispatch-safety-concern-notice!
  ...
  every other responsible party of a flagged electrical-hazard/
  incomplete-repair concern."
